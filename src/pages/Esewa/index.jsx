...
export default function Esewa({ userData }) {
  function payment(e){
    e.preventDefault();
  ...
  return (
    <>
      <form action="https://uat.esewa.com.np/epay/main" method="POST">
        ...
        />
        <input
          value="http://localhost:3001/?payment=success"
          type="hidden"
          name="su"
        />
        <input
          value="http://localhost:3001/?payment=failed"
          type="hidden"
          name="fu"
        />
        ...
        <div className="py-3">Click here to pay using Esewa</div>
        {
          ...
          :
          <input onClick={(e) => payment(e)} class="my-2 mx-auto px-4 btn btn-dark" value="Pay" type="submit" />
        }
